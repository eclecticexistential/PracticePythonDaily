...
def game_loop():
    ...
    playing = True
    # generates moves according to grid size
    ...
    while playing:
        ...
        if move == 'QUIT':
            print("\n ** Buh-bye! ** \n")
            break
        #for all of the available moves player has
        if move in valid_moves:
            #returns x,y
            player = move_player(player,move)

            if player == monster:
                print("\n ** Oh noes! The monster got you! Better luck next time. **\n")
                playing = False
            if player == door:
            ...
            print("\n ** Unable to phase through wall at this time! ** \n")
    else:
